...
public class LoginProfesseur extends JFrame {
	...
	public LoginProfesseur() {
		...
		JLabel lblNewLabel = new JLabel("Espace de Prodesseur");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				gestionProfesseur Admin=new gestionProfesseur();
				if(Admin.ExsiteProfesseur(email,id)==true) {
					dispose();
